const Footer = () => {
  return (
    <div className="relative flex bg-[#111111]  flex-col items-center h-full w-full uppercase text-white font-lol ">
      <div className="absolute top-0 left-0 w-full flex items-center justify-center p-6 text-sm  bg-[#292929] font-medium">
        <a
          href=""
          className="hover:bg-neutral-700 transition duration-300 px-5 py-2 rounded-lg"
        >
        ...
        <a
          ...
          className="hover:bg-neutral-700 transition duration-300 px-5 py-2 rounded-lg"
        >
          descarga la aplicacion de league of legends
        </a>
      </div>
      <div className="flex flex-row gap-3 mt-24 text-center">
        <span className="bg-[#292929] p-2 size-8 mx-auto rounded-xl flex items-center justify-center">
          YT
        </span>
        <span className="bg-[#292929] p-2 size-8 mx-auto rounded-xl flex items-center justify-center">
          X
      ...
      <div className="text-white flex flex-col mt-12 items-center justify-center">
        <a
          href="https://www.riotgames.com/es"
          target="_blank"
          className="opacity-50 hover:opacity-100"
        >
          <svg width="99" height="32" viewBox="0 0 587.93 165" fill="white">
        ...
        <p className="text-[13px] font-lol font-medium text-center max-w-2xl mt-8 normal-case text-[#7E7E7E]">
          ™ &amp; © 2024 Riot Games Inc. Todos los derechos reservados. Riot
          Games, League of Legends y PvP.net son marcas comerciales, marcas de
          servicios o marcas registradas de Riot Games, Inc.
        </p>
        <div className="my-5">
          <a
            href=""
      ...
      <div className="p-4 flex gap-4 bg-[#292929] rounded-lg mt-4">
        <img
          className="w-[67px] h-[100px]"
          src="https://cmsassets.rgpub.io/sanity/images/dsfx7636/riotbar/ab90fbef0af776f146814953b5f311e22a6b761d-165x247.png?&h=100&fit=max"
          alt=""
        />
        <ul className="flex flex-col text-[13px] normal-case font-bold">
          <li>Sangre</li>
          <li>Violencia de fantasía</li>
          <li>Temas insinuantes moderados</li>
          <li>Uso de alcohol y tabaco</li>
          <li>Interacciones en linea no clasificadas por la ESRB</li>
        </ul>
      </div>
    </div>
  );
